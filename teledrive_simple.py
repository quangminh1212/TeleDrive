...
async def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("\nUsage:")
        print("  python teledrive_simple.py list <channel> [limit]")
        print("  python teledrive_simple.py search <channel> <query> [limit]")
        print("  python teledrive_simple.py download <channel> <file_number>")
        print("  python teledrive_simple.py upload <channel> <file_path> [caption]")
        print("\nExamples:")
        print("  python teledrive_simple.py list @mychannel 10")
        print("  python teledrive_simple.py search @mychannel 'video' 5")
        print("  python teledrive_simple.py download @mychannel 1")
        print("  python teledrive_simple.py upload @mychannel ./file.pdf 'My document'")
        return
    ...
    try:
        ...
        if command == "list":
            if len(sys.argv) < 3:
                print("❌ Usage: python teledrive_simple.py list <channel> [limit]")
                return
            ...
            if len(sys.argv) < 4:
                print("❌ Usage: python teledrive_simple.py search <channel> <query> [limit]")
                return
            ...
            if len(sys.argv) < 4:
                print("❌ Usage: python teledrive_simple.py download <channel> <file_number>")
                return
            ...
            if len(sys.argv) < 4:
                print("❌ Usage: python teledrive_simple.py upload <channel> <file_path> [caption]")
                return
