...
python -c "import sys; import os; sys.path.insert(0, 'src'); from utils.simple_logger import setup_simple_logging; setup_simple_logging(); print('[OK] He thong logging da san sang')" 2>nul
if errorlevel 1 (
